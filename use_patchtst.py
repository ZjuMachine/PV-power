...
if __name__ == '__main__':
    ...
    for args.pred_len in [16,48,96,96*4,96*7]:
        # args.station_name='8'  # 0  1 2  4 7  8 
        # args.pred_len=96
        args.model= 'PatchTST' #,'Transformer'  # 'PatchTSTfusion' 
        ...
        args.encoder_type=None  #'tcnlstm' #'tcn' #'bilstm' #'lstm' 
        ...
        if args.seq_len==16:
            ...
            args.patch_len = 16 # 32  
        elif args.seq_len==96:
            args.patch_len = 32 # 32  
        elif args.seq_len==96*4:
            args.patch_len = 64 # 32  
        elif args.seq_len==96*7:
            args.patch_len =64 # 32  
