...
if __name__ == '__main__':
    ...
    # for args.station_name in ['4','7','8']: # ['0','4','7','8']
    for args.pred_len in [16,48,96,96*4,96*7]:# [16,48,96,96*4,96*7]
        ...
        args.model= 'TimeFilter' #select model
        # args.useweather=True # use wather forward helping
        # args.use_satell=False # use satellite data
        # args.station_name='0'
        # args.deployment=True # use corrdiff for deployment
