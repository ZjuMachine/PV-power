...
if __name__ == '__main__':
    ...
    # parser.add_argument('--output_attention', default=False, action="store_true", help='output_attention')
    ...
    for args.pred_len in [16,48,96,96*4,96*7]:# [16,48,96,96*4,96*7]:   #[16,48,96,96*4,96*7]:
        args.model= 'PatchMLP' #,'Transformer'  # 'PatchTSTfusion'    #'PatchTST'  'other_paper'
        args.encoder_type=None  #'tcnlstm' #'tcn' #'bilstm' #'lstm'  # 'cnn_lstm'   #'1dcnn'   #  'gru'    #'1dcnn'  
        ...
        args.use_norm=True
        if args.seq_len==16:
            args.patch_len_arryay = [8,4,2,2] # 32  
        elif args.seq_len==48:
            args.patch_len_arryay =  [16,8,4,2]  # 32  
        elif args.seq_len<96*4.1:
            args.patch_len_arryay = [48, 24, 12, 6] # 32  
        else:
            args.patch_len_arryay = [48*2, 24*2, 12*2, 6*2] # 32               
    ##########################################################################
