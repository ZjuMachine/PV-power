...
if __name__ == '__main__':
    ...
    #                     help='model name, options: [PatchTST, iTransformer]')
    ...
    ##########################################################################
        ...
        args.model_id='Formaltry-'+args.model+'-station-'+args.station_name  #'Try_tcnlstm'   #'Try_tcn'   #'Try_bilstm'  #'Try_lstm'     #'Try_cnn_lstm'       # 'Try_1dcnn'   #'Try_1dcnn'  'Try_gru'
