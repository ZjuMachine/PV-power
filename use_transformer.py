...
if __name__ == '__main__':
    ...
    for args.pred_len in [16,48,96,96*4,96*7]:# [16,48,96,96*4,96*7，16,48,96,96*4,]:   #[16,48,96,96*4,96*7]:
        # args.station_name='8'  # 0  1 2  4 7  8 
        # args.pred_len=96
        args.model= 'Transformer' #,'Transformer'  # 'PatchTSTfusion'    #'PatchTST'  'other_paper'
